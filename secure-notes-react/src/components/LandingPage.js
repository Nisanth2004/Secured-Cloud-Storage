  ...
  return (
    <div className="min-h-[calc(100vh-74px)] flex justify-center">
      <div className="lg:w-[80%] w-full py-16  space-y-4  ">
        ...
        >
          TURN YOUR DATA INTO SECURE, ENCRYPTED INFORMATION—ANYTIME, ANYWHERE.
        </motion.h1>
        <h3 className="text-logoText md:text-2xl text-xl font-semibold text-slate-800 text-center">
          The #1 secure data cloud storage 
        </h3>
        <p className="text-slate-700 text-center sm:w-[80%] w-[90%] mx-auto">
        Discover Exception-Handlers, the ultimate choice in secure data storage, where innovation meets privacy. Our cutting-edge encryption app is designed to keep your most sensitive information locked away—safe, organized, and accessible only to you.
        </p>
        <motion.div
          initial="hidden"
          animate="visible"
